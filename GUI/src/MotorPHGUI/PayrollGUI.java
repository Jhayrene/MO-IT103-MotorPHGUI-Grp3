...
public class PayrollGUI extends JFrame {
    ...
    private String attendanceFile = "\"C:\\Users\\HP-VICTUS\\OneDrive\\Documents\\NetBeansProjects\\GUI\\src\\main\\resources\\MotorPH Employee Data - Attendance Record.csv\"";

    public PayrollGUI() {
        // Load employees at startup
        employees = LoadEmployeeData.loadFromFile("src/main/resources/Employee Details.csv");
        ...
        calculateButton.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                if (filteredLogs.isEmpty()) {
                    ...
                    double pagibig = governmentContribution.CalculatePagIbig.computeFromWeekly(basicGrossMonthlyPay / 4.0);
                    double philhealth = governmentContribution.CalculatePhilHealth.computeFromWeekly(basicGrossMonthlyPay / 4.0);
                    double sss = GovernmentContribution.CalculateSss.computeFromWeekly(basicGrossMonthlyPay / 4.0);
                    double withholdingTax = GovernmentContribution.CalculateWithholdingTax.compute(basicGrossMonthlyPay);
